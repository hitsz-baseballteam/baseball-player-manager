  ...
  ws.games = [
    {
      ...
      statLines: [
        {
          playerId,
          pa: 4, ab: 4, h: 2, doubles: 0, triples: 0, hr: 1, rbi: 2, r: 2,
          sb: 0, bb: 0, hbp: 0, sf: 0, so: 1,
      ...
      statLines: [
        {
          ...
          hr: 0,
          rbi: 0,
          r: 0, sb: 0, bb: 1, hbp: 0, sf: 0, so: 1,
          ip: 1.2, er: 1, soPitching: 2, bbPitching: 0, hPitching: 2,
          po: 0, a: 0, e: 0, w: 0, l: 0, sv: 0, np: 0,
        },
      ],
    },
    {
      ...
      statLines: [
        {
          playerId,
          pa: 4, ab: 3, h: 1, doubles: 0, triples: 0, hr: 0, rbi: 1, r: 1,
          sb: 1, bb: 1, hbp: 0, sf: 0, so: 0,
